...
export const projects = [
  ...
  },
  {
    ...
    service: 'cv-service',
    year: '2025',
    kind: { fa: 'بک‌اند', en: 'Backend', de: 'Backend' },
    featured: true,
    title: {
    ...
    tagline: {
      fa: 'ثبت، سازمان‌دهی و جست‌وجوی رزومه‌ها و اطلاعات متقاضیان.',
      en: 'Store, organize, and search candidate resumes and professional data.',
      de: 'Lebensläufe und Bewerberdaten speichern, organisieren und durchsuchen.',
    },
    problem: {
      fa: 'رزومه‌ها به‌صورت فایل‌های پراکنده نگهداری می‌شدند و پیدا کردن فرد مناسب برای یک موقعیت زمان‌بر بود.',
      en: 'Resumes lived as loose files, making it slow to find the right person for a given role.',
      de: 'Lebensläufe lagen als lose Dateien vor — die passende Person für eine Rolle zu finden war mühsam.',
    },
    approach: {
      fa: 'مدل‌سازی داده متقاضیان روی Django و SQL Server، با فرم‌های ثبت ساختاریافته و فیلترهای جست‌وجو روی مهارت‌ها و سوابق.',
      en: 'Candidate data modeled with Django and SQL Server, with structured intake forms and search filters over skills and history.',
      de: 'Bewerberdaten mit Django und SQL Server modelliert, mit strukturierten Formularen und Suchfiltern über Fähigkeiten und Verlauf.',
    },
    result: {
      fa: 'اطلاعات متقاضیان در یک جای واحد، قابل جست‌وجو و قابل گزارش‌گیری شد.',
      en: 'Candidate information became searchable and reportable from one place.',
      de: 'Bewerberinformationen wurden an einem Ort durchsuchbar und auswertbar.',
    },
    stack: ['Python', 'Django', 'SQL Server', 'Database Design'],
    links: {
